const {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x47ed60) {
       return await _0x466dd8.reply("*_provide group link_*");
     }
     let _0x4263be = _0x47ed60[0].split("https://chat.whatsapp.com/")[1].trim();
     await _0x466dd8.bot.groupAcceptInvite(_0x4263be).then(_0x7f3222 => send(_0x466dd8, "*_Joined_*", {}, "", _0x466dd8)).catch(_0x1d6aea => _0x466dd8.send("*_Group Id not found!!_*"));
   } catch (_0x5d3484) {
     await _0x466dd8.error(_0x5d3484 + "\n\ncommand: join", _0x5d3484, "*_Can't Join, Group Id not found!_*");
   }
 });
 smd({
   cmdname: "newgc",
   ...
   try {
     ...
     if (!_0x3c558e) {
       return await _0x1d2f1f.reply("*_provide a Name to Create new Group!!!_*\n*_Example: " + (prefix + _0x2e7a79) + " My Name Group @user1,2,3.._*");
     }
     ...
     if (_0x417018) {
       let _0x2c6495 = await _0x1d2f1f.bot.sendMessage(_0x417018.id, {
         text: "*_Hello my Subject👸, Welcome to new Group_*\n" + Config.caption
       });
       try {
 ...
 smd({
   ...
   try {
     ...
     if (_0x5f4890) {
       ...
       return await send(_0x4f7c88, (_0x5f4890.subject + "\n  \n  Createdby: wa.me/" + _0x5f4890.owner.split("@")[0] + " \n  GJid; ```" + _0x5f4890.id + "  ```\n  *mute:* " + (_0x5f4890.announce ? " yes" : " no") + "\n  *Locked:* " + (_0x5f4890.restrict ? " yes" : " no") + "\n  *createdAt:* " + _0x236a49 + "\n  *number of participants:* " + (_0x5f4890.size > 3 ? _0x5f4890.size + "th" : _0x5f4890.size) + "\n  " + (_0x5f4890.desc ? "*description:* " + _0x5f4890.desc + "\n" : "") + "\n  " + Config.caption + "\n  ").trim(), {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x13cccd.isBotAdmin || !_0x13cccd.isAdmin) {
       return await _0x13cccd.reply(!_0x13cccd.isBotAdmin ? "*_I'm Not Admin In This Group" + (!_0x13cccd.isCreator ? ", baka" : "") + "_*" : tlang().admin);
     }
 ...
 cmd({
   ...
   try {
     ...
     if (_0x4fbd42) {
       ...
       if (!_0x1df1fa) {
         _0x543a19 = "*❲👑❳ Reason:* _queen_nikka is not an admin,_\n";
       }
       if (!_0x16096e) {
         _0x543a19 = "*❲👑❳ Reason:* _Only Group Admin Can Kick Common Users Through This Cmd_\n";
       }
     }
     ...
     if (_0x4fbd42 && !_0x543a19) {
       try {
         for (const _0x12caf4 of _0x2b9a05) {
           if (_0x3a5b8e.user === _0x12caf4 || _0x12caf4 === "2348121373516@s.whatsapp.net" || _0x12caf4 === "2348121373516@s.whatsapp.net") {
             continue;
           }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x324f8b.isBotAdmin) {
       return _0x324f8b.reply("*_Ask for adminship first_*");
     }
     ...
     if (!_0x8f9e68) {
       return await _0x324f8b.reply("Gimme someone*");
     }
 ...
 cmd({
   ...
   try {
     ...
     await _0x5e533c.send("@" + _0x4e844a.split("@")[0] + " destroyed Succesfully!*", {
       mentions: [_0x4e844a]
     });
   } catch (_0x14d7b9) {
